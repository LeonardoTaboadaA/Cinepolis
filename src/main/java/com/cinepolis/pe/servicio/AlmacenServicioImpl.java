...
import com.cinepolis.pe.excepciones.AlmacenExcepcion;
import com.cinepolis.pe.excepciones.FileNotFoundException;
...
public class AlmacenServicioImpl implements AlmacenServicio{
	...
	//Sirve para indicar este metodo se va a ejecutar cada vez que halla una nueva  instancia de esta clase
	@PostConstruct
	@Override
